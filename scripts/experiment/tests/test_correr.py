...
from correr import comando_locust, corrida_deteccion, segundos_tope, tamanos
...
def test_segundos_tope_incluye_margen() -> None:
    # 1000 cotizaciones a 500/min = 120 s, más 30 s de margen.
    assert segundos_tope(1000, 500) == 150
