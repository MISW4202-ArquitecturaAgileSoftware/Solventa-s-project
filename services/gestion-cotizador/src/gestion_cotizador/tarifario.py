...
Esa es la condición que hace determinista el cálculo: la misma solicitud con la
misma versión de tarifario produce siempre el mismo resultado.

Se mantienen dos versiones a propósito: `2026.02` es la vigente y `2025.11` es
la anterior, que sirve para probar que el tarifario está versionado y que dos
versiones distintas producen primas distintas.
"""
...
from gestion_cotizador.contracts import Canal
from gestion_cotizador.errors import ErrorValidacion, TarifarioDesconocido
...
# Tabla anterior: tasas y gasto ligeramente menores.
_2025_11 = Tarifario(
