"""Cálculo determinista de la prima.
...
from gestion_cotizador import tarifario as tarifario_mod
...
def calcular(
    ...
    """Aplica la fórmula del plan (§2.3 de la rama `main`) y devuelve el
    resultado con su explicación."""
