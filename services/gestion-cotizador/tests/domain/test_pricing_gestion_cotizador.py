...
from gestion_cotizador import tarifario
...
from gestion_cotizador.pricing import calcular, edad_cumplida


def test_ejemplo_canonico(solicitud_canonica: SolicitudCotizacion) -> None:
    """Criterio de cierre de F4. Si este número cambia, todo el plan cambia."""
