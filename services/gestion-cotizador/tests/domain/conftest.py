"""Fixtures compartidas: el ejemplo canónico del plan (PLAN-IMPLEMENTACION.md)."""
...
# Fecha de cálculo fija. Congelarla es lo que hace reproducible el test: la
# edad del ejemplo canónico (38) depende de ella.
